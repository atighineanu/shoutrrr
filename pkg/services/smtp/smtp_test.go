...
var _ = Describe("the SMTP service", func() {
	...
	When("parsing the configuration URL", func() {
		It("should be identical after de-/serialization", func() {
			testURL := "smtp://user:password@example.com:2225/?auth=None&fromaddress=sender@example.com&fromname=Sender&starttls=No&subject=Subject&toaddresses=rec1@example.com,rec2@example.com&usehtml=No"
